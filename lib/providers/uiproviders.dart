...
final workspaceNotifierProvider = ChangeNotifierProvider((ref) => WorkSpaceProvider());
...
class WorkSpaceProvider extends ChangeNotifier{
  ...
  void setHeight(BuildContext context) async {
    double heightLarge = screenHeightExcludingToolbar(context) - MediaQuery.of(context).padding.top;
